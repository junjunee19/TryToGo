...
public class ModifyNoticeRequest {
	...
	public ModifyNoticeRequest(int notice_no, String notice_title, Date notice_wdate, String notice_content) {
		super();
	...
	public NoticeVO toNoticeVO(){
		return new NoticeVO(notice_no,notice_title,notice_wdate,notice_content);
	} 
}
